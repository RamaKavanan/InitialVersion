<?php
    ...
    return array(
        ...
        'Active currencies can be used when creating new records and as a default currency for a user.'
            => 'Aktive Währungen können bei der Erstellung neue Datensätze und als Standard-Währung für einen Benutzer',
        ...
        'Copyright &#169; GICRM Inc., 2013. All Rights reserved.'
            => 'Copyright © GICRM Inc., 2013. Alle Rechte vorbehalten.',
        ...
        'File failed to upload. The file is empty.'
            => 'Datei konnte nicht hochgeladen. Die Datei ist leer.',
        'Files'
            => 'Dateien',
        'Filter By Created User'
            => 'Filtern nach erstellt Benutzer',
        'Filtered Lists'
            => 'Gefilterte Listen',
        'Financial Services'
        ...
        'Incorrect username or password.'
            => 'Falsche Benutzername oder Kennwort.',
        'Industry'
        ...
        'Label must be all lowercase.'
            => 'Kennsatz muss alle Kleinbuchstaben sein',
        'Label must not be empty.'
            => 'Kennsatz darf nicht leer sein',
        'Label must not contain any special characters.'
            => 'Kennsatz darf keine Sonderzeichen.',
        'Language'
            => 'Sprache',
        'Languages'
            => 'Sprachen',
        ...
        'Manage Currency Configuration'
            => 'Verwaltung der Währung Konfiguration',
        'Manage Global Configuration'
            => 'Verwaltung der Globale Konfiguration',
        'Manage Groups'
        ...
        'Module Name - Plural (lowercase)'
            => 'Modul Name - Plural (Kleinbuchstaben)',
        'Module Name - Singular'
            => 'Modul Name - Singular',
        'Module Name - Singular (lowercase)'
            => 'Modul Name - Singular (Kleinbuchstaben)',
        'Module Permissions'
            => 'Modul Berechtigungen',
        'Module Permissions Saved Successfully.'
            => 'Modul Berechtigungen erfolgreich gespeichert.',
        'Mr.'
            => 'Herr',
        'Mrs.'
            => 'Frau',
        ...
        'Search by name, phone, or e-mail'
            => 'Suche nach Name, Telefon oder e-mail',
        'Secondary Address'
            => 'Sekundäre Adresse',
        'Secondary Email'
            => 'Sekundäre E-Mail',
        ...
        'Select a Parent Role'
            => 'Wählen Sie eine übergeordnete Rolle',
        'Select a Role'
        ...
        'skipped because you do not have sufficient permissions.'
            => 'Übergesprungen weil Sie nicht die richtige Berechtigung haben. ',
        ...
        'to continue to the home page. If the error persists please contact your administrator.'
            => 'auf der Homepage weiter. Falls der Fehler bestehen wenden Sie sich bitte an Ihren Administrator.',
        'Tradeshow'
            => 'Messe',
