<?php
     ...
     */
    class MyAddProductsView extends View    {
        /**
...
//                    Yii::getPathOfAlias('application.modules.agreementProducts.elements.assets')) . '/AgreementProductTemplateUtils.js');
        ...
        protected function renderXHtmlHead()
        {
            ...
            $cs->registerCssFile($themeBaseUrl . '/custom-css/I2it-Custom.css' .
                        ZurmoAssetManager::getCssAndJavascriptHashQueryString("themes/default/custom-css/I2it-Custom.css"));
